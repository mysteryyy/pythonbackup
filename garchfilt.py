...
import sys
import investpy
k1=investpy.search_quotes(text='TATASTEEL',products=['stocks'],countries=['India'],n_results=2)[0].retrieve_historical_data(from_date='01/01/2018',to_date='16/12/2018')

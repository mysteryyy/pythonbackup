...
k1=investpy.search_quotes(text='Most Shares M100',products=['stocks'],countries=['India'],n_results=2)[0]

k1 = investpy.get_etf_historical_data(stock=k1.symbol,country='India',from_date='01/01/2010',to_date='20/03/2021')
